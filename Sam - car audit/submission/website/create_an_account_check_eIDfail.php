<?php
	...
	{
		//errorlog function
		errorlog("create_an_account_check_eIDfail.php","$conn conection error");
		//kill the connection
	...
	if(isset($_SESSION['eID']))
	{
		...
		if ($sql_result->num_rows > 0)
		{
			...
			while($row = $sql_result->fetch_assoc())
			{
				...
				{
					//errorlog function
					errorlog("create_an_account_check_eIDfail.php","Error: Incorrect or no SID, user has tried to enter a restricted area");
					//redirect
				...
				{
					//alert and redirect
					jsalert("Error: Sorry, that eID is already in the database. Please enter another one.","create_an_account.php");
				}
			}
		}
		else
		{
		//errorlog function
		errorlog("create_an_account_check_eIDfail.php","No $_SESSION[eID] set");
		//redirect
		header("Location: index.php");
		}
	}
